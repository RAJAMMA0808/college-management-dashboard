...
import { LogoutIcon, AcademicCapIcon, ChartBarIcon, BookOpenIcon } from './icons';

type View = 'dashboard' | 'comparison' | 'courses';
      ...
      <div className="flex-grow">
        ...
        <nav className="space-y-2">
            ...
            {user.role === Role.CHAIRMAN && (
              <div role="button" tabIndex={0} onClick={() => setView('comparison')} onKeyDown={(e) => e.key === 'Enter' && setView('comparison')} className={navItemClass('comparison')}>
